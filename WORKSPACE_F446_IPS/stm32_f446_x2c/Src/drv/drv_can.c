...
*/
 /*   CanHandle.Init.SJW = CAN_SJW_1TQ;
    ...
    CanHandle.Init.Prescaler = 5;		// number of time quanta = 45000000/(5*500000) = 18
     CanHandle.Init.SJW = CAN_SJW_1TQ;
     CanHandle.Init.BS1 = CAN_BS1_14TQ; // sample point at : (1+14)/18 = 0.75 (75%)
